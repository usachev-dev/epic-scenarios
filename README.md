...
Есть три способа их выбрать: _случайный_, _стратегический_ и _сбалансированный_.
...
При балансном, за каждую категорию параметра игроки бросают д6. При равенстве значений выбирается тот параметр, который выпал на кубике. Если выпали разные значения, игрок, который выбросил больше, выбирает между двумя параметрами под выпавшими номерами. ПРИМЕР: при выборе типа расстановки Петр кинул 5, Василий кинул 3. Петр может выбрать между типом расстановки 3 (наброс по секторам) и типом расстановки 5 (город).
Игрок, выбравший меньше параметров, получает +2 на бросок в стратегическую фазу первого хода.
...
В этой игре запрещен pre-measure. Можно мерить дистанцию только после того, как вы заявили, какое действие вы производите.
